/* DTrackSDK: C++ header file, A.R.T. GmbH 21.4.05-25.1.07
 *
 ...
 *
 * $Id: DTrack.hpp,v 1.5 2007/02/19 17:54:43 kurt Exp $
 */
...
private:
	...
	int d_udptimeout_us;            // timeout for receiving and sending
